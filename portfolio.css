...
let projectPreviewClosing = false;
...
function saveProject() {
    ...
    if (editIndex === null) {
        ...
        if (
            projects[editIndex] &&
            projects[editIndex].designConcept
        ) {
...
function createExtraProjectContent(project) {
    ...
    if (
        ...
        highlightsHTML = `
            ...
            <section class="project-extra-section project-highlights-section">
                        ...
                        project.highlights
                            .map(
                                (highlight, index) => `
                                    ...
                                    <div
                                        class="project-highlight-card highlight-item-${index + 1}"
                                    >
    ...
    if (
        ...
        featuresHTML = `
            ...
            <section class="project-extra-section project-key-features-section">
                        ...
                        project.features
                            .map(
                                (feature, index) => `
                                    ...
                                    <div
                                        class="project-feature-item feature-item-${index + 1}"
                                    >
    ...
    if (project.designConcept) {
        ...
        conceptHTML = `
            ...
            <section class="project-extra-section project-design-concept-section">
    ...
    if (
        ...
        roleHTML = `
            ...
            <section class="project-extra-section project-my-role-section">
...
function openProjectPreview(project, sourceCard) {

    if (projectPreviewClosing) {
        return;
    }
    ...
    if (previewBox) {
        ...
        previewBox.style.clipPath =
            "inset(8%)";

        previewBox.style.transition =
            "opacity 550ms ease, clip-path 550ms ease";
    ...
    if (activeProjectCard) {
        ...
        activeProjectCard.style.transformStyle =
            "preserve-3d";

        activeProjectCard.style.backfaceVisibility =
            "hidden";

        activeProjectCard.style.willChange =
            "transform, opacity";

        activeProjectCard.style.transformOrigin =
            "center center";


        activeProjectCard.animate(
            ...
            [
                ...
                {
                    transform:
                        "perspective(1200px) rotateY(90deg) scale(.98)",
                    opacity: "1",
                    offset: 0.45
                },
                ...
                {
                    transform:
                        "perspective(1200px) rotateY(180deg) scale(.96)",
                    opacity: "0"
                }
            ],
...
function closeProjectPreview() {
    ...
    if (previewBox) {
        ...
        previewBox.style.transition =
            "opacity 450ms ease, clip-path 450ms ease";
            ...
            if (activeProjectCard) {
                ...
                activeProjectCard.animate(
                    ...
                    [
                        ...
                        {
                            transform:
                                "perspective(1200px) rotateY(270deg) scale(.98)",
                            opacity: "0",
                            offset: 0.45
                        },
                        ...
                        {
                            transform:
                                "perspective(1200px) rotateY(360deg) scale(1)",
                            opacity: "1"
                        }
                    ],
    ...
    setTimeout(
        function () {
            ...
            if (activeProjectCard) {
                ...
                activeProjectCard.style.transform =
                    "";

                activeProjectCard.style.opacity =
                    "";
